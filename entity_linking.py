...
dev_pos = [[x[0]+1,x[1]+1]for x in train_pos]
...
valid_dataset = SPO_BERT_LINK(dev_X, t, pos=train_pos, type=train_type)

train_batch_size = 1024
valid_batch_size = 1024

model = EntityLink(encoder_size=128, dropout=0.2, num_outputs=len(data_manager.type_list))
